...
@section('meta-tags')
    <title>NSC STATIONERY | Error: 500 | Top Stationery Supplier in Africa</title>
@endsection
@section('content')
        ...
        <section class="inner-page-padding">
            <div class="container">
                <div class="row _5-column-fix">
                   <div class="col-lg-9">
                        <div class="row">
                            <img class="_500-img" src="{{asset('frontend/img/500.jpg')}}" alt="500" style="background-color: #d8d8d8;width: 900px;height: 506px;">
                        </div>
                   </div>
                   {{-- sidebar --}}
